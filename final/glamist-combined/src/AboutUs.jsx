...
const AboutUs = () => {
  ...
  const salonStaff = [
    { name: 'Emma', role: 'Hair Stylist', image: 'https://images.unsplash.com/photo-1524504388940-b539e2b79567?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60' },
    { name: 'Sophie', role: 'Nail Technician', image: 'https://images.unsplash.com/photo-1595955715236-3d874dc93b2b?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60' },
    { name: 'Olivia', role: 'Tattoo Artist', image: 'https://images.unsplash.com/photo-1517841902196-6c34e20592fd?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60' },
    { name: 'Charlotte', role: 'Piercing Specialist', image: 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60' },
    { name: 'Amelia', role: 'Skin Care Expert', image: 'https://images.unsplash.com/photo-1519419691348-3b3433c4c81e?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60' },
  ];
